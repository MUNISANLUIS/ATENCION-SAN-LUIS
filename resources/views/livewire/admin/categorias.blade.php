            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-200">
                        ...
                        <span class="text-lg font-bold text-indigo-600 ml-2">{{ $categorias->total() }}</span>
                    </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    {{ $categoria->estado == 1 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                    {{ $categoria->estado == 1 ? 'Activo' : 'Inactivo' }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ \Carbon\Carbon::parse($categoria->fecha_creacion)->format('d/m/Y') }}
                                </div>
                                <div class="text-xs text-gray-500">
                                    {{ \Carbon\Carbon::parse($categoria->fecha_creacion)->format('H:i') }}
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-lg font-medium">No se encontraron categorías</p>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="text-sm text-gray-700">
                    Mostrando
                    <span class="font-semibold text-gray-900">{{ $categorias->firstItem() ?? 0 }}</span>
                    a
                    <span class="font-semibold text-gray-900">{{ $categorias->lastItem() ?? 0 }}</span>
                    de
                    <span class="font-semibold text-gray-900">{{ $categorias->total() }}</span>
                    categorías
                </div>
                <div>
                    {{ $categorias->links() }}
            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
                ...
                <div
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="text-sm text-red-600 font-semibold mt-2">
                                        ⚠️ Esta acción no se puede deshacer. No podrás eliminar la categoría si tiene tickets asociados.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                        ...
                        <button type="button" wire:click="deleteCategoria"
