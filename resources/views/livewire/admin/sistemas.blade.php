            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-200">
                        <span class="text-sm text-gray-600">Total sistemas:</span>
                        <span class="text-lg font-bold text-blue-600 ml-2">{{ $sistemas->total() }}</span>
                    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-xs space-y-1">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-semibold text-gray-900 ml-1">{{ $sistema->intervalo_minutos }} min</span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="w-3 h-3 mr-1 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <span class="font-semibold text-gray-900 ml-1">{{ $sistema->timeout_segundos }} seg</span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    {{ $sistema->estado == 1 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                    {{ $sistema->estado == 1 ? 'Activo' : 'Inactivo' }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ \Carbon\Carbon::parse($sistema->fecha_creacion)->format('d/m/Y') }}
                                </div>
                                <div class="text-xs text-gray-500">
                                    {{ \Carbon\Carbon::parse($sistema->fecha_creacion)->format('H:i') }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    {{-- Edit Button --}}
                                    <button wire:click="edit({{ $sistema->id }})"
                                    ...
                                    {{-- Delete Button --}}
                                    <button wire:click="confirmDelete({{ $sistema->id }})"
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-lg font-medium">No se encontraron sistemas</p>
     ...
     <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
         ...
         <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
             ...
             {{-- Modal panel --}}
             <div
                 class="relative inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full z-50">
                 {{-- Header --}}
                 ...
                 <div class="bg-white px-6 py-6">
                     <div class="space-y-4">
                         ...
                         <div>
                             ...
                             <input type="url" wire:model="url_base"
                                 class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                 placeholder="https://ejemplo.com">
                             <p class="text-xs text-gray-500 mt-1">URL completa del sistema a monitorear</p>
                             @error('url_base')
                                 <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                             @enderror
                         </div>
                         ...
                         <div>
                             ...
                             <textarea wire:model="headers" rows="3"
                                 class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                 placeholder='{"Authorization": "Bearer token", "Content-Type": "application/json"}'></textarea>
                             <p class="text-xs text-gray-500 mt-1">Headers HTTP en formato JSON (opcional)</p>
                             @error('headers')
                                 <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                             @enderror
                         </div>
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                             ...
                             <div>
                                 ...
                                 <input type="number" wire:model="intervalo_minutos" min="1" max="1440"
                                     class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                     placeholder="5">
                                 <p class="text-xs text-gray-500 mt-1">Frecuencia de monitoreo (1-1440 min)</p>
                             ...
                             <div>
                                 ...
                                 <input type="number" wire:model="timeout_segundos" min="5" max="300"
                                     class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                     placeholder="30">
                                 <p class="text-xs text-gray-500 mt-1">Tiempo máximo de espera (5-300 seg)</p>
                                 @error('timeout_segundos')
                                     <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                 @enderror
                             </div>
                         </div>
         ...
         <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
             ...
             <div
                         ...
                         <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                             ...
                             <div class="mt-3">
                                 ...
                                 <p class="text-sm text-red-600 font-semibold mt-2">
                                     ⚠️ Esta acción no se puede deshacer y eliminará toda la configuración de monitoreo asociada.
                                 </p>
                             </div>
                         </div>
                     </div>
                 ...
                 <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                     ...
                     <button type="button" wire:click="deleteSistema"
