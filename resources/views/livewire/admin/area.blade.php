            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-200">
                        ...
                        <span class="text-lg font-bold text-indigo-600 ml-2">{{ $areas->total() }}</span>
                    </div>
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-lg font-medium">No se encontraron áreas</p>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="text-sm text-gray-700">
                    Mostrando
                    <span class="font-semibold text-gray-900">{{ $areas->firstItem() ?? 0 }}</span>
                    a
                    <span class="font-semibold text-gray-900">{{ $areas->lastItem() ?? 0 }}</span>
                    de
                    <span class="font-semibold text-gray-900">{{ $areas->total() }}</span>
                    áreas
                </div>
                <div>
                    {{ $areas->links() }}
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="abreviatura"
                                    class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                    placeholder="Ej: RRHH" maxlength="10">
                                @error('abreviatura')
                                    <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                @enderror
                            </div>
            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
                ...
                <div
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="text-sm text-red-600 font-semibold mt-2">
                                        ⚠️ Esta acción no se puede deshacer. No podrás eliminar el área si tiene tickets asociados.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                        ...
                        <button type="button" wire:click="deleteArea"
